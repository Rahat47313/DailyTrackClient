...
export default function SidebarLeft() {
  ...
  return (
    <>
      <aside className="fixed top-0 left-0 z-40 md:z-10 w-64 h-screen pt-5 md:pt-20 transition-all -translate-x-full md:translate-x-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
