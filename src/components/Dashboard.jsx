        ...
        <div className="p-4 border-2 rounded-lg border-gray-200 dark:border-gray-700 mt-[60px]">
          ...
          <button className="flex flex-col border-b border-gray-200 dark:border-gray-700 py-3 px-5 w-full">
            ...
            <div className="flex xxs:hidden md:flex pl-4 text-xs">
              ...
              <div className="flex items-center gap-2 border-r px-4">
                <div className="flex items-center justify-center w-3 h-3 p-[5px] text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-white">
                  1
                </div>
                <div>Subtasks</div>
              </div>
