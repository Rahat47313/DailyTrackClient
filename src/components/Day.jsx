        ...
        <div className="flex items-center">
          ...
          <Menu as="div" className="relative ml-6 md:hidden">
            ...
            <Transition
              ...
              leaveTo="transform opacity-0 scale-95"
            >
              <Menu.Items className="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-200 dark:divide-gray-700 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  <Menu.Item>
                    {({ active }) => (
                      <a
